...
interface EmployeeDashboardStatsCardsProps {
  dashboardData: DashboardData;
  className?: string;
}

const EmployeeDashboardStatsCards: React.FC<EmployeeDashboardStatsCardsProps> = ({ 
  dashboardData, 
  className = "" 
}) => {
  const {
        ...
        <div className="relative bg-white/90 backdrop-blur-sm rounded-2xl p-4 lg:p-6 border border-white/30 shadow-lg group-hover:shadow-xl transition-all duration-300 hover:scale-[1.02]">
          <div className="flex items-center justify-between">
            <div className="space-y-1 lg:space-y-2">
              ...
              <p className="text-xs text-slate-500">All time requests</p>
            </div>
        ...
        <div className="relative bg-white/90 backdrop-blur-sm rounded-2xl p-4 lg:p-6 border border-white/30 shadow-lg group-hover:shadow-xl transition-all duration-300 hover:scale-[1.02]">
          <div className="flex items-center justify-between">
            <div className="space-y-1 lg:space-y-2">
              ...
              <p className="text-xs text-slate-500">Successfully approved</p>
            </div>
...
export default EmployeeDashboardStatsCards;
