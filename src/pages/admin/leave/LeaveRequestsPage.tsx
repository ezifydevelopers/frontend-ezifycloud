...
const LeaveRequestsPage: React.FC<WithDashboardDataProps> = ({ 
              ...
              <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                <div className="space-y-3">
                  ...
                  <p className="text-slate-600 text-base lg:text-lg">
                    Manage and review all leave requests from employees
                  </p>
...
const LeaveRequestsPageWithData = withDashboardData(LeaveRequestsPage);
export default LeaveRequestsPageWithData;
