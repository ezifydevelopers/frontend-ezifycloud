...
const OffshoreEmployeeDashboard: React.FC<WithDashboardDataProps> = ({ 
  ...
  const fetchUpcomingHolidays = async () => {
    try {
      ...
      console.log('🔍 OffshoreEmployeeDashboard: Fetching upcoming holidays...');
      const response = await employeeAPI.getUpcomingHolidays(10);
      console.log('📅 OffshoreEmployeeDashboard: Holidays response:', response);
      if (response.success && response.data) {
        ...
        console.log('✅ OffshoreEmployeeDashboard: Holidays fetched successfully:', holidays);
      } else {
        console.log('❌ OffshoreEmployeeDashboard: No holidays data:', response);
        setUpcomingHolidays([]);
      }
    } catch (error) {
      console.error('❌ OffshoreEmployeeDashboard: Error fetching upcoming holidays:', error);
      setUpcomingHolidays([]);
    } finally {
  ...
  useEffect(() => {
    ...
    const fetchDashboardData = async () => {
      ...
      try {
        ...
        console.log('🔍 Offshore Employee Dashboard: Starting data fetch...');

        // Fetch comprehensive dashboard data from backend
        console.log('🔍 OffshoreEmployeeDashboard: Fetching dashboard stats from backend...');
        const dashboardStatsResponse = await employeeAPI.getDashboardStats({ _t: Date.now() } as Record<string, unknown>).catch(error => {
          console.error('❌ OffshoreEmployeeDashboard: Failed to fetch dashboard stats:', error);
          return { success: false, data: null };
        });
        console.log('🔍 OffshoreEmployeeDashboard: Dashboard stats response:', dashboardStatsResponse);
        ...
        console.log('🔍 Offshore Employee Dashboard: Processed dashboardStats:', dashboardStats);

        if (dashboardStats) {
          console.log('🔍 Offshore Employee Dashboard: Processing dashboard data:', dashboardStats);
          ...
          console.log('🔍 Offshore Employee Dashboard: Processed data:', processedData);
          ...
          console.log('🔍 Offshore Employee Dashboard: Using fallback data');
          const fallbackData = {
            stats: {
              quickStats: {
                totalRequests: 5,
  ...
  console.log('🔍 OffshoreEmployeeDashboard: dashboardData:', dashboardData);
  console.log('🔍 OffshoreEmployeeDashboard: Centralized data:', centralizedData);
  ...
  if (loading) {
    return (
      <div className="flex-1 space-y-8 p-6 bg-gradient-to-br from-slate-50 via-purple-50/30 to-pink-50/50 min-h-screen">
        ...
        <div className="space-y-6">
              ...
              <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                <div className="space-y-3">
                  <div className="flex items-center gap-3 flex-wrap">
                    ...
                    <div className="flex items-center gap-3 flex-wrap">
                      <h1 className="text-3xl lg:text-4xl font-bold tracking-tight bg-gradient-to-r from-purple-600 via-pink-600 to-purple-600 bg-clip-text text-transparent">
                        Offshore Employee Dashboard
                      </h1>
          ...
          <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
                  ...
                  <CardContent>
                    {recentRequests.length > 0 ? (
                      <div className="space-y-3">
                        {recentRequests.map((request: Record<string, unknown>) => (
                          <div 
                            ...
                            className="group p-4 rounded-2xl border border-slate-200/50 bg-gradient-to-r from-slate-50 to-purple-50/30 hover:shadow-md hover:border-purple-200/50 transition-all duration-200 cursor-pointer"
                      ...
                      <div className="text-center py-8">
                        <div className="p-3 bg-gradient-to-r from-purple-50 to-pink-50 rounded-full w-16 h-16 mx-auto mb-4 flex items-center justify-center">
            ...
            <div className="space-y-6">
              ...
              <div className="relative group">
                <div className="absolute inset-0 bg-gradient-to-r from-green-500/10 to-purple-500/10 rounded-3xl blur-sm group-hover:blur-md transition-all duration-300"></div>
                <Card className="relative bg-white/90 backdrop-blur-sm border-white/30 shadow-xl rounded-3xl">
                  <CardHeader className="pb-4">
                    <CardTitle className="flex items-center gap-3 text-xl">
                      <div className="p-2 bg-gradient-to-r from-green-500 to-purple-500 rounded-xl">
                  ...
                  <CardContent className="space-y-3">
                    <Button
                      ...
                      className="w-full justify-start bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 h-12 text-base font-medium shadow-lg hover:shadow-xl transition-all duration-200"
                    >
              ...
              <div className="relative group">
                ...
                <Card className="relative bg-white/90 backdrop-blur-sm shadow-xl rounded-3xl bg-gradient-to-br from-purple-50/50 to-pink-50/50 border-purple-200/50">
                  <CardHeader className="pb-4">
                    <CardTitle className="flex items-center gap-3 text-xl">
                      <div className="p-2 rounded-xl bg-gradient-to-r from-purple-500 to-pink-500">
                        <Building2 className="h-5 w-5 text-white" />
                      </div>
                      Offshore Employee Information
                    </CardTitle>
                  ...
                  <CardContent className="space-y-4">
                    <div className="grid gap-4 md:grid-cols-2">
                      <div>
                        ...
                        <div className="flex items-center gap-2">
                          <p className="text-lg font-semibold capitalize">Offshore</p>
                          <Badge className="bg-purple-100 text-purple-800 border-purple-200">
                            <Plane className="h-3 w-3 mr-1" />
                            Offshore
                          </Badge>
...
const OffshoreEmployeeDashboardWithData = withDashboardData(OffshoreEmployeeDashboard, {
  autoFetch: true,
  refreshInterval: 30000, // 30 seconds
  cacheTimeout: 60000 // 1 minute
});

export default OffshoreEmployeeDashboardWithData;
