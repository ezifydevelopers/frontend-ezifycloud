...
import { UpcomingHoliday } from '@/types/api/employee';
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-2 mb-2">
            <h1 className="text-3xl font-bold tracking-tight">Offshore Employee Dashboard</h1>
          ...
          <CardContent>
            {holidaysLoading ? (
              ...
              <div className="space-y-3">
                {upcomingHolidays.map((holiday, index: number) => (
                  <div
                    key={index}
...
export default withDashboardData(OffshoreEmployeeDashboard);
