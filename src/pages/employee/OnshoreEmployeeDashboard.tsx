...
const OnshoreEmployeeDashboard: React.FC<WithDashboardDataProps> = ({ 
  ...
  const fetchUpcomingHolidays = async () => {
    try {
      ...
      console.log('🔍 OnshoreEmployeeDashboard: Fetching upcoming holidays...');
      const response = await employeeAPI.getUpcomingHolidays(10);
      console.log('📅 OnshoreEmployeeDashboard: Holidays response:', response);
      if (response.success && response.data) {
        ...
        console.log('✅ OnshoreEmployeeDashboard: Holidays fetched successfully:', holidays);
      } else {
        console.log('❌ OnshoreEmployeeDashboard: No holidays data:', response);
        setUpcomingHolidays([]);
      }
    } catch (error) {
      console.error('❌ OnshoreEmployeeDashboard: Error fetching upcoming holidays:', error);
      setUpcomingHolidays([]);
    } finally {
  ...
  useEffect(() => {
    ...
    const fetchDashboardData = async () => {
      ...
      try {
        ...
        console.log('🔍 Onshore Employee Dashboard: Starting data fetch...');

        // Fetch comprehensive dashboard data from backend
        console.log('🔍 OnshoreEmployeeDashboard: Fetching dashboard stats from backend...');
        const dashboardStatsResponse = await employeeAPI.getDashboardStats({ _t: Date.now() } as Record<string, unknown>).catch(error => {
          console.error('❌ OnshoreEmployeeDashboard: Failed to fetch dashboard stats:', error);
          return { success: false, data: null };
        });
        console.log('🔍 OnshoreEmployeeDashboard: Dashboard stats response:', dashboardStatsResponse);
        ...
        console.log('🔍 Onshore Employee Dashboard: Processed dashboardStats:', dashboardStats);

        if (dashboardStats) {
          console.log('🔍 Onshore Employee Dashboard: Processing dashboard data:', dashboardStats);
          ...
          console.log('🔍 Onshore Employee Dashboard: Processed data:', processedData);
          ...
          console.log('🔍 Onshore Employee Dashboard: Using fallback data');
          const fallbackData = {
            stats: {
              quickStats: {
                totalRequests: 5,
  ...
  console.log('🔍 OnshoreEmployeeDashboard: dashboardData:', dashboardData);
  console.log('🔍 OnshoreEmployeeDashboard: Centralized data:', centralizedData);
  ...
  if (loading) {
    return (
      <div className="flex-1 space-y-8 p-6 bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/50 min-h-screen">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="space-y-6">
          ...
          <div className="relative">
            <div className="absolute inset-0 bg-gradient-to-r from-blue-600/10 via-indigo-600/10 to-blue-600/10 rounded-3xl blur-3xl"></div>
              ...
              <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                <div className="space-y-3">
                  <div className="flex items-center gap-3 flex-wrap">
                    ...
                    <div className="flex items-center gap-3 flex-wrap">
                      <h1 className="text-3xl lg:text-4xl font-bold tracking-tight bg-gradient-to-r from-blue-600 via-indigo-600 to-blue-600 bg-clip-text text-transparent">
                        Onshore Employee Dashboard
                      </h1>
          ...
          <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
                  ...
                  <CardContent>
                    {recentRequests.length > 0 ? (
                            ...
                            <div className="flex items-center justify-between">
                              <div className="flex items-center space-x-3">
                                <Avatar className="h-10 w-10 ring-2 ring-white shadow-md">
                                  <AvatarFallback className="bg-gradient-to-r from-blue-500 to-indigo-500 text-white font-semibold text-sm">
                      ...
                      <div className="text-center py-8">
                        <div className="p-3 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-full w-16 h-16 mx-auto mb-4 flex items-center justify-center">
            ...
            <div className="space-y-6">
                ...
                <Card className="relative bg-white/90 backdrop-blur-sm border-white/30 shadow-xl rounded-3xl">
                  ...
                  <CardContent className="space-y-3">
                    <Button
                      ...
                      className="w-full justify-start bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 h-12 text-base font-medium shadow-lg hover:shadow-xl transition-all duration-200"
                    >
              ...
              <div className="relative group">
                <div className="absolute inset-0 bg-gradient-to-r from-indigo-500/10 to-blue-500/10 rounded-3xl blur-sm group-hover:blur-md transition-all duration-300"></div>
                <Card className="relative bg-white/90 backdrop-blur-sm shadow-xl rounded-3xl bg-gradient-to-br from-blue-50/50 to-indigo-50/50 border-blue-200/50">
                  <CardHeader className="pb-4">
                    <CardTitle className="flex items-center gap-3 text-xl">
                  ...
                  <CardContent className="space-y-4">
                    <div className="grid gap-4 md:grid-cols-2">
                      <div>
                        ...
                        <div className="flex items-center gap-2">
                          <p className="text-lg font-semibold capitalize">Onshore</p>
                          <Badge className="bg-blue-100 text-blue-800 border-blue-200">
                            <MapPin className="h-3 w-3 mr-1" />
                            Onshore
                          </Badge>
              ...
              {/* Notifications */}
              <div className="relative group">
                <div className="absolute inset-0 bg-gradient-to-r from-blue-500/10 to-indigo-500/10 rounded-3xl blur-sm group-hover:blur-md transition-all duration-300"></div>
                <Card className="relative bg-white/90 backdrop-blur-sm border-white/30 shadow-xl rounded-3xl">
                  <CardHeader className="pb-4">
                    <CardTitle className="flex items-center gap-3 text-xl">
                      ...
                      <div className="space-y-3 max-h-[300px] overflow-y-auto">
                        {notifications.map((notification: Record<string, unknown>) => (
                          <div 
                            ...
                            className="p-3 rounded-lg border border-slate-200/50 bg-gradient-to-r from-slate-50 to-blue-50/30 hover:shadow-md transition-all duration-200"
                          >
...
const OnshoreEmployeeDashboardWithData = withDashboardData(OnshoreEmployeeDashboard, {
  autoFetch: true,
  refreshInterval: 30000, // 30 seconds
  cacheTimeout: 60000 // 1 minute
});

export default OnshoreEmployeeDashboardWithData;
